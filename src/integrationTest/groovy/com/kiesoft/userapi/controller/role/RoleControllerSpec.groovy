...
class RoleControllerSpec extends Specification {
    ...
    def "createNewRole: role created when it does not exist and validation successful"() {
        given:
        ...
        when:
        final result = mockMvc.perform(MockMvcRequestBuilders.post(ROUTING_ROLE_CONTROLLER + ROUTING_ROLE_CREATE)
    ...
    def "createNewRole: validation fails when missing name"() {
        given:
    ...
    def "createNewRole: validation fails when name too small"() {
        given:
        final createRoleDTO = new CreateUserDTO.Builder()
                .name("ROLE")
                .build()
    ...
    def "createNewRole: validation fails when name too big"() {
        given:
        final createRoleDTO = new CreateUserDTO.Builder()
